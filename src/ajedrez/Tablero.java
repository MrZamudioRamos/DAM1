...
public class Tablero {
    ...
    public void setTabla(Pieza[][] tablero) {
    ...
    public void Mover(Movimiento mov) {
        ...
        Pieza movPieza = devuelvePieza(mov.getPosInicial());
        
        ponPieza(movPieza, mov.getPosFinal());
        quitaPieza(mov.getPosInicial());
    }

    public boolean esValido(Movimiento mov, boolean turnoJugador) {
